...
## How this package is installed

### 1. Link the shared Tailwind config
...
Install the shared Tailwind preset so the UI package uses the same design tokens as the apps.

### 2. Point shadcn/ui at the shared stylesheet
...
Export the theme variables and base styles that shadcn/ui components expect.

### 3. Add `components.json`

Configure shadcn/ui to reuse the shared Tailwind stylesheet and package aliases.
